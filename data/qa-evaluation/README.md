...
`golden-v1.json` is a synthetic, versioned test corpus. The deterministic harness expands every
scenario across English, Hausa, Igbo, and Yoruba and scores citation and policy behaviour. The
maintainer reviewed all four locale records on 19 September 2026. This records maintainer review,
not independent language review, and the corpus is test material rather than public content.
...
It requires `GROQ_API_KEY`, records only case IDs, outcomes, and model/prompt/schema versions,
