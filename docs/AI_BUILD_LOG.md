...
- **Commands run and results:** `make backend-integration` exit 0 (336 passed); `make backend-verify` exit 0 (760 passed); `make openapi-generate` then check clean; Circle 0 validators passed.
